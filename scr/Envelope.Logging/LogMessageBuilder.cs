...
public class LogMessageBuilder : LogMessageBuilder<Guid>
{
	public LogMessageBuilder(MethodLogScope<Guid> methodLogScope)
		: base(methodLogScope)
	{
	}

	public LogMessageBuilder(ITraceInfo<Guid> traceInfo)
		: base(traceInfo)
	{
	}

	public LogMessageBuilder(LogMessage<Guid> logMessage)
		: base(logMessage)
	{
	}
}